    ...
    $.fn.Tabledit = function (options) {
        ...
        var Draw = {
            ...
            rows: {
                addLast: function () {
                    if (settings.addButton) {
                        ...
                        var $td = $table.find('tr:last td:nth-child(' + (parseInt(settings.columns.identifier[0]) + 1) + ')');
            ...
            columns: {
                ...
                editAndDeleteButtons: function (rows, first) {
                    ...
                    rows.append('<td style="white-space: nowrap; width: 1%;">' + toolbar + '</td>')

                },
                andNewAndSaveButtons: function (row) {
                    var toolbarWithAddButton = '<div class="tabledit-toolbar ' + settings.toolbarClass + '" style="text-align: left;">\n\
                                           <div class="' + settings.groupClass + '" style="float: none;">' + addButton + '</div>\n\
                                           ' + saveNewButton + '\n\
                                       </div></div>';
                    row.append('<td style="white-space: nowrap; width: 1%;">' + toolbarWithAddButton + '</td>');
                }
            }
        };
        ...
        var Mode = {
            view: function (td) {
                ...
                if (settings.addButton) {
                    $tr.find('button.tabledit-save-new-button').hide();
                    $tr.find('button.tabledit-add-button').removeClass('active').blur();
                }
            },
            edit: function (td) {
                Delete.reset(td);
            ...
            add: function (td) {
                ...
                // Update toolbar buttons.
                if (settings.editButton) {
                    $tr.find('button.tabledit-add-button').addClass('active');
                    $tr.find('button.tabledit-save-new-button').show();
                }
            }
        };
            ...
            submit: function (td) {
                ...
                var ajaxResult = ajax(settings.buttons.add.action)
                    .done(function (data) {
                        ...
                        //replace add button with plus
                        Draw.columns.editAndDeleteButtons($(".table tr:last"));
        ...
        var editButton = '<button type="button" class="tabledit-edit-button ' + settings.buttons.edit.class + '" style="float: none;">' + settings.buttons.edit.html + '</button>';
        var deleteButton = '<button type="button" class="tabledit-delete-button ' + settings.buttons.delete.class + '" style="float: none;">' + settings.buttons.delete.html + '</button>';
        var saveButton = '<button type="button" class="tabledit-save-button ' + settings.buttons.save.class + '" style="display: none; float: none;">' + settings.buttons.save.html + '</button>';
        var restoreButton = '<button type="button" class="tabledit-restore-button ' + settings.buttons.restore.class + '" style="display: none; float: none;">' + settings.buttons.restore.html + '</button>';
        var confirmButton = '<button type="button" class="tabledit-confirm-button ' + settings.buttons.confirm.class + '" style="display: none; float: none;">' + settings.buttons.confirm.html + '</button>';
        var addButton = '<button type="button" class="tabledit-add-button ' + settings.buttons.add.class + '" style="float: none;">' + settings.buttons.add.html + '</button>';
        var saveNewButton = '<button type="button" class="tabledit-save-new-button ' + settings.buttons.saveNew.class + '" style="display: none; float: none;">' + settings.buttons.saveNew.html + '</button>';


        Draw.rows.addLast();
        Draw.columns.andNewAndSaveButtons($(".table tr:last"));
        //var cloneOfLastRow = $(".table tr:last").clone();
        Draw.columns.identifier($table.find('tbody td:nth-child(' + (parseInt(settings.columns.identifier[0]) + 1) + ')'));
        Draw.columns.editable();
        Draw.columns.editAndDeleteButtons($table.find('tr').not(':first').not(':last'), true);

        var copyOfNewRow = $(".table tr:last").clone();
